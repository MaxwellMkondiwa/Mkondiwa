...
BLOG_AUTHOR = "Maxwell Mkondiwa"  # (translatable)
BLOG_TITLE = "maxwellmkondiwa"  # (translatable)
...
BLOG_EMAIL = "mkond001@umn.edu"
BLOG_DESCRIPTION = "I am a PhD candidate in Applied Economics at the University of Minnesota"  # (translatable)
